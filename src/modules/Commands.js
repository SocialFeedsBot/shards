...
module.exports = class CommandsModule extends Collection {
  ...
  async execute(message, command) {
    ...
    try {
      await message.reply([
        ':x: **Commands starting with the `sf!` prefix have been disabled.**',
        ...
        'If you do not see any commands, kick the bot and invite it using this link: <https://socialfeeds.app/invite>'
      ].join('\n'));
    } catch (err) {
